...
app.post('/api/favorites', async (req, res) => {
  try {
    ...
    const data = await client.query(`
      ...
      RETURNING   id, movie_id AS "movieId", title, year, genre, rating, img, user_id AS "userId";
    `, [favorite.movieId, favorite.title, favorite.year, favorite.genre, favorite.rating, favorite.img, req.userId]);
